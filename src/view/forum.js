...
document.addEventListener('DOMContentLoaded', function() {
    ...
    link.rel = 'stylesheet';
    link.href = '../styles/forum.css'; 

    // Menambahkan link tag ke dalam head dokumen
    ...
    dynamicContent.innerHTML = mainContent + popupForm;
    ...
    document.getElementById('questionForm').addEventListener('submit', function(event) {
        ...
        const newDiscussion = {
            avatar: "../images/default-avatar.jpeg", // asumsikan ada avatar default
            userName: userName,
            postTime: postTime,
            content: content,
            replies: "0 Jawaban",
        ...
        // Menambahkan ke array discussions dan memperbarui tampilan
        discussions.push(newDiscussion);
        const item = createDiscussionItem(newDiscussion);
        document.getElementById('discussion-container').appendChild(item);

        // Mengosongkan form dan menutup pop-up
...
function addCommentForm(discussionItem, discussion) {
    ...
    form.onsubmit = function(event) {
        ...
        if (commentContent) {
            // Misalkan nama pengguna diambil dari sesi atau konteks global
            const userName = sessionStorage.getItem('userName') || 'Nama Pengguna Anonim'; // Contoh pengambilan dari sessionStorage

            const newComment = {
                avatar: "../images/default-avatar.jpeg", // Ganti dengan avatar pengguna jika ada
                userName: userName, // Menggunakan nama pengguna dari sesi atau default
                postTime: new Date().toLocaleTimeString(), // Format waktu bisa disesuaikan
...
// Modifikasi fungsi createDiscussionItem untuk memanggil addCommentForm
